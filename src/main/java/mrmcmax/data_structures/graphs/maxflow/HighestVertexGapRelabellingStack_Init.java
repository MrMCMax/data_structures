...
public class HighestVertexGapRelabellingStack_Init extends FlowAlgorithm {

	public HighestVertexGapRelabellingStack_Init() {
		super("HighestVertexGapRelabellingStack_Init");
	}
